...
BOT_TOKEN = environ.get("BOT_TOKEN", "8481197785:AAHxgbDw-5bsfX1InK-xpxz8GWhGCWpooFU")
if len(BOT_TOKEN) == 0:
...
OWNER_ID = environ.get("OWNER_ID", "7778005218")
if len(OWNER_ID) == 0:
...
TELEGRAM_API = environ.get("TELEGRAM_API", "27570787")
...
TELEGRAM_HASH = environ.get("TELEGRAM_HASH", "f5e4d37759af94d4efc2dfb58b30af39")
